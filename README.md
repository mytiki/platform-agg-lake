# Aggregation: Lake
Deploy an encrypted [Iceberg](https://iceberg.apache.org) data lake to any [AWS S3](https://aws.amazon.com/s3/) account with a provisioned access point for management by mytiki.com.
...
- [Report a Vulnerability](https://github.com/mytiki/platform-agg-lake/security/advisories/new)
